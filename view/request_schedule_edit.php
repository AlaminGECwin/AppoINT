                        ...
                        <table class="table table-bordered table-sm ">
                          ...
                          <tbody >
                            ...
                            function get_button($schedule_id,$slot_button,$hour,$i,$month,$year)
                            {
                              ...
                              if($slot_button=="1")
                              { ?>
                              <a href="index.php?function=edit_problem&schedule_id=<?php echo $schedule_id;?>&status=<?php echo "available";?>&slot=<?php echo $hour-10;?>&date=<?php echo $i;?>&month=<?php echo $month;?>&year=<?php echo $year;?>&counselor_id=<?php echo $_GET['counselor_id'];?>">
