...
<div id="login">
        <h3 class="text-center text-dark pt-5">Client Setup form</h3>
        <div class="container">
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="index.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="request_type" value="client_setup">
                            <div class="form-group">
                                
                                <input type="submit" name="setup_client" class="btn btn-info btn-md" value="Next">
                            </div>
                        </form>
