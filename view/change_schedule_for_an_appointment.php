...
<div class="container cont">
	...
	<div>
		<form action="index.php" method="get">
			 ...
			 <input type="hidden" name="function" value="request_schedule">
			 <div class="form-group">
	...
	<div class="table-responsive-lg" id="divtb">
		<table class="table table-bordered table-sm ">
		  ...
		  <tbody >
		  	...
		  	$day_schedule = array("1","2","2","3","1","2","3","3");
		  	function get_button($slot_button)
		  	{
		  		if($slot_button=="1")
		  		{
		  			available_button();
			...
			?>
			      ...
			      <td class="m-0 p-0 ">
			      	...
			      	if($available){
			      		get_button($day_schedule[$hour-10]);
